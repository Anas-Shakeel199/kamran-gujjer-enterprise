...
const Sale = ({
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      setSuccessMessage(
        `Sale ${saved.billNumber} successfully save ho gayi!`
      );
      ...
      setErrorMessage(
        typeof error === "string"
          ? error
          : "Sale save karte waqt masla ho gaya. Dobara try karein."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const inputClass =
    "w-full rounded-xl border border-slate-700 bg-slate-800 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 hover:border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20";
        ...
        <div className="mx-auto max-w-[1500px]">
          ...
          <header className="mb-8">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-400">
                      Naya maal sale entry add karein.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="hidden h-11 w-11 items-center justify-center rounded-xl bg-slate-900 text-sm font-bold uppercase text-blue-400 sm:flex">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 px-4 py-3">
                  ...
                  <p className="mt-1 text-sm font-semibold capitalize text-blue-400">
                    {user.username}
                  </p>
                </div>
              </div>
          ...
          {successMessage && (
            <div className="mb-6 flex items-start gap-3 rounded-2xl border border-blue-500/20 bg-blue-500/10 px-4 py-4">
              ...
              <button
                ...
                className="rounded-lg p-1.5 text-blue-500/60 transition hover:bg-blue-500/10 hover:text-blue-400"
              >
                <X size={17} />
              </button>
            </div>
                ...
                <div className="sticky top-6 overflow-hidden rounded-2xl border border-slate-800 bg-slate-900">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 rounded-2xl border border-blue-500/20 bg-blue-500/5 p-5">
                      ...
                      <p className="mt-2 text-3xl font-bold tracking-tight text-blue-400">
                        {formatCurrency(
                          totalAmount
                        )}
                      </p>

                      <div className="mt-4 h-px bg-blue-500/10" />
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-950/20 transition hover:bg-blue-500 hover:shadow-blue-950/30 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      {isLoading ? (
                        <>
                          <Loader2
                    ...
                    <p className="mt-3 text-center text-[11px] leading-5 text-slate-600">
                      Save karne ke baad sale stock aur
